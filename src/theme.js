...
const THEMES = {
  ...
  terminal: {
    ...
    glow: true,
    tokens: {
      bgGradient: 'radial-gradient(120% 120% at 50% 0%, #041a0d 0%, #000600 70%)',
      background: { default: '#010a04', paper: '#04130a' },
      accent: '#33ff88',
      accentInk: '#00190a',
      ink: '#8dffb0',
      muted: '#4fae6c',
      line: 'rgba(51,255,136,0.20)',
      cardBg: 'rgba(6,24,13,0.6)',
      readerBg: 'rgba(3,15,8,0.92)',
      readerText: '#7dfca1',
      heading: '#b6ffce',
      codeBg: 'rgba(51,255,136,0.10)',
      preBg: '#010c05',
      shadow: '0 0 0 1px rgba(51,255,136,0.12), 0 18px 44px -26px rgba(0,40,15,0.9)',
    },
  },
};
